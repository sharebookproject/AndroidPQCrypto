...
public class AlgorithmIdentifier extends ASN1Sequence {
     ...
     * <p>
     * 
     * The keys encoding must be either a a {@link codec.pkcs8.PrivateKeyInfo
     * PrivateKeyInfo} or a {@link codec.x509.SubjectPublicKeyInfo SubjectPublicKeyInfo}.
     * 
     * @param key
     ...
     * @throws codec.CorruptedCodeException
