...
public class SubjectPublicKeyInfo extends ASN1Sequence {
    ...
    /**
     * Creates an instance with the given {@link codec.x509.AlgorithmIdentifier
     * AlgorithmIdentifier} and encoded public key. The public key is wrapped
     * into an {@link codec.asn1.ASN1BitString ASN1BitString} as required by the
    ...
    /**
     * Returns the {@link codec.x509.AlgorithmIdentifier AlgorithmIdentifier} of the public
     * key.
     * 
