...
public class PrivateKeyInfo extends ASN1Sequence {
    ...
    /**
     * The {@link codec.asn1.ASN1ObjectIdentifier OID} of the private key algorithm used in
     * this structure.
     */
    protected AlgorithmIdentifier algorithm_;

    /**
     * Stores the <b>encoded</b> {@link java.security.PrivateKey private Key}. The
     ...
     * @param key
     *                The raw key that shall be wrapped in this instance.
     * @throws codec.InconsistentStateException
    ...
    /**
     * Returns the {@link codec.x509.AlgorithmIdentifier AlgorithmIdentifier} of the
     * embedded key.
     * 
    ...
    /**
     * Sets the {@link codec.x509.AlgorithmIdentifier AlgorithmIdentifier} of this
