...
public class Attribute extends ASN1Sequence implements ASN1RegisteredType {
     ...
     * {@link codec.asn1.OIDRegistry OIDRegistry} is used to resolve the attribute type. If
     ...
     * value</code> can be
     * <code>null</code> and is replaced by {@link codec.asn1.ASN1Null ASN1Null} in that
     * case.
     * 
     * @param oid
