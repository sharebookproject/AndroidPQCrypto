 ...
 * 
 * This class is used to convert SaferPlus keys into a format usable by the
 * FlexiProvider. The supported KeySpec class is SaferPlusKeySpec.
 * <p>
 ...
 */
public class SAFERPlusKeyFactory extends SecretKeyFactory {

	/**
	 * Generate a SAFER+ key object from the provided key specification. The key
	...
	public SecretKey generateSecret(KeySpec keySpec)
		...
		if (keySpec instanceof SecretKeySpec) {
			...
			if (secKeySpec.getAlgorithm().equals(SAFERPlus.ALG_NAME)) {
				return new SAFERPlusKey(secKeySpec.getEncoded());
			}
		}
	...
	public KeySpec getKeySpec(SecretKey key, Class keySpec)
		...
		if ((key == null) || !(key instanceof SAFERPlusKey)) {
