 ...
 * {@link SAFERPlusKeyGenerator}. The parameters consist of the key size in
 * bits. Values for the key size are 128, 192, and 256 bits, with the default
 * being 128 bits.
 * 
 * @author Martin D_ring
 */
public class SAFERPlusKeyGenParameterSpec implements AlgorithmParameterSpec {
     ...
     */
    public SAFERPlusKeyGenParameterSpec() {
     ...
     */
    public SAFERPlusKeyGenParameterSpec(int keySize) {
