 ...
 * 
 * This class is used to convert Camellia keys into a format usable by the
 * FlexiProvider. The supported KeySpec class is CamelliaKeySpec.
 * <p>
 ...
 */
public class CamelliaKeyFactory extends SecretKeyFactory {

	/**
	 * Generate a Camellia key object from the provided key specification. The
	...
	public SecretKey generateSecret(KeySpec keySpec)
		...
		if (keySpec instanceof SecretKeySpec) {
			...
			if (secKeySpec.getAlgorithm().equals(Camellia.ALG_NAME)) {
				return new CamelliaKey(secKeySpec.getEncoded());
			}
		}
	...
	public KeySpec getKeySpec(SecretKey key, Class keySpec)
		...
		return new SecretKeySpec(key.getEncoded(), "Camellia");
	}

	/**
	 * Translates a Camellia key object, whose provider may be unknown or
