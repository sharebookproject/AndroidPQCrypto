 ...
 * {@link SerpentKeyGenerator}. The parameters consist of the key size in bits.
 * Values for the key size are 128, 192, and 256 bits, with the default being
 * 128 bits.
 * 
 * @author Martin D_ring
 */
public class SerpentKeyGenParameterSpec implements AlgorithmParameterSpec {
     ...
     */
    public SerpentKeyGenParameterSpec() {
     ...
     */
    public SerpentKeyGenParameterSpec(int keySize) {
