...
public final class GoppaCode {
	...
	/**
	 * Construct a new {@link de.flexiprovider.common.math.codingtheory.GoppaCode.MaMaPe} container with the given parameters.
	 * 
	 * @param s
	 *                the first matrix
	 * @param h
     ...
     * <tt>P</tt> as {@link de.flexiprovider.common.math.codingtheory.GoppaCode.MaMaPe}. The matrix <tt>(Id | M)</tt> is called
