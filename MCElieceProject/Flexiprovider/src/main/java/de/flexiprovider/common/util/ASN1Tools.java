...
public final class ASN1Tools {
    ...
    /**
     * Create a new {@link ASN1Integer} from the given {@link de.flexiprovider.common.math.FlexiBigInt}
     * value.
     * 
     * @param value
     *                the {@link de.flexiprovider.common.math.FlexiBigInt} value
     * @return a new {@link ASN1Integer} holding the {@link de.flexiprovider.common.math.FlexiBigInt} value
     */
    ...
    /**
     * Get the {@link de.flexiprovider.common.math.FlexiBigInt} value from the given {@link ASN1Integer}.
     * 
     * @param value
     *                the {@link ASN1Integer}
     * @return the {@link de.flexiprovider.common.math.FlexiBigInt} value stored in the {@link ASN1Integer}
     */
