 ...
 * </ol>
 * 
 * @see de.flexiprovider.pqc.ecc.ECCKeyGenParameterSpec
 * @author Elena Klintsevich
 * @author Martin D_ring
 */
public class McElieceCCA2KeyPairGenerator extends KeyPairGenerator {
     ...
     * {@link de.flexiprovider.pqc.ecc.ECCKeyGenParameterSpec}. If the parameters are <tt>null</tt>, the
     * default parameters are used (see {@link de.flexiprovider.pqc.ecc.ECCKeyGenParameterSpec}).
     * 
     * @param params
     *                the parameters
     * @param random
     ...
     *                 {@link de.flexiprovider.pqc.ecc.ECCKeyGenParameterSpec}.
     */
	...
	// generate keys
	McElieceCCA2PublicKey pubKey = new McElieceCCA2PublicKey(n, t, shortG);
	McElieceCCA2PrivateKey privKey = new McElieceCCA2PrivateKey(n, k,
		field, gp, p, h, qInv);
